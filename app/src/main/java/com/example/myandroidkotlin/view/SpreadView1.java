 ...
 * @since JDK 1.8
 */
public class SpreadView1 extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public SpreadView1(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SpreadView1(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        }
        ...
        mDrawableRadius = Math.min((mBorderRect.height() - mBorderWidth) / 2.0f, (mBorderRect.width() - mBorderWidth) / 2.0f);

        mDrawableRect.set(mBorderRect);
        if (!mBorderOverlay && mBorderWidth > 0) {
            mDrawableRect.inset(mBorderWidth - 1.0f, mBorderWidth - 1.0f);
        }
        mDrawableRadius = Math.min(mDrawableRect.height() / 2.0f, mDrawableRect.width() / 2.0f) / 2;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (spreadRadius.get(spreadRadius.size() - 1) > mDrawableRadius / 2) {
            spreadRadius.add(0);
            alphas.add(255);
        }
